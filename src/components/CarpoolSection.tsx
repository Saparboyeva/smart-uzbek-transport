...
import { regionRides } from "@/data/regionData";

const CarpoolSection = () => {
  const { toast } = useToast();
  const { selected, regionName } = useRegion();
  const rides = regionRides[selected];
    ...
    <section id="carpool" className="py-24 bg-muted/50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2">Birga yuring — tejang ({regionName})</h2>

    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-card/80 backdrop-blur-lg border-b border-border">
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#route" className="bg-primary text-primary-foreground px-5 py-2 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
            Boshlash
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-card border-b border-border px-4 pb-4 space-y-3">
          ...
          <a href="#route" className="block bg-primary text-primary-foreground px-5 py-2 rounded-lg text-sm font-semibold text-center">
            Boshlash
          </a>
        </div>
      )}
